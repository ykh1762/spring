...
public class RangerController {
	...
	// @ModelAttribute가 적용된 메서드는 @RequestMapping이 적용된 메서드가 실행되기전에
...
//	}
	...
	// @PathVariable : url의 일부 값을 변수로 치환해서 개발자가 해당 값을 사용하기
	// 쉽게 받을 수 있는 어노테이션. localhost/ranger/pathVariable/* 의 요청을 받음.
	...
	public String getRangerParam(@RequestParam(name="listIndex", defaultValue="0")
			int listIndex, Model model){
		String ranger = rangerService.getRanger(listIndex);
		model.addAttribute("ranger", ranger);
